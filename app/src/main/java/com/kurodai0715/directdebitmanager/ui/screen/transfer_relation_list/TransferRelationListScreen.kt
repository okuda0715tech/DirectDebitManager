...
@Composable
fun TransferRelationListScreen(modifier: Modifier = Modifier) {
    TransferRelationListContents(modifier)
}

@Composable
fun TransferRelationListContents(modifier: Modifier = Modifier) {
