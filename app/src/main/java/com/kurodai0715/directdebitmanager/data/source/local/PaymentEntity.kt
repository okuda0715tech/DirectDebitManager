...
data class PaymentItemEntity(
    ...
    /**
     * この  [PaymentEntity] が振替元として登録されたかものどうかを判別するためのもの.
     *
    ...
    /**
     * この [PaymentEntity] の振替元の [PaymentEntity] の ID .
     *
     * 0 の場合、この [PaymentEntity] は、振替元を持たない（つまり、ルートである）ことを意味する。
     */
    val parentId: Int = 0,
